var Composition = (function () {
  ...
  var counter = {
      signField: {count : 0, id : 0, input: true},
      commentField: {count : 0, id : 0, input: true},
      dateField: {count : 0, id : 0, input: false},
      emailField: {count : 0, id : 0, input: true} 
  };
              ...
              callback: function () {
                ...
                for (var typeOfField in counter) {
                  if ($(this).hasClass(typeOfField)) {                  
                    ...
                    for (var typeOfField in counter) {
                      if ( counter[typeOfField].input ) {
                        numOfInputFields += counter[typeOfField].count;
                      }
                    }
...
function getHTML() {
  ...
  $( "#JSONDiv" ).children().first().html( JSON.stringify( pages ) );
